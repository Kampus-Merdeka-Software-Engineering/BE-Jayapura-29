  ...
  fetch(apiUrl)
    ...
    .then((profileData) => {
      ...
      document.getElementById("profile-name").textContent =
        profileData.nama_pasien;
      document.getElementById("profile-id").textContent = profileData.id_pasien;
      document.getElementById(
        "jumlah-bayar"
      ...
      document.getElementById(
        "nama-pasien"
      ).textContent = `Nama Pasien: ${profileData.nama_pasien}`;
      document.getElementById(
        "email-pasien"
      ).textContent = `Email Pasien: ${profileData.email_pasien}`;
      document.getElementById(
        "gender"
      ).textContent = `Gender: ${profileData.gender}`;
      document.getElementById(
        "nomor-ponsel"
      ).textContent = `Nomor Ponsel: ${profileData.nomor_ponsel}`;
      document.getElementById(
        "alamat"
      ).textContent = `Alamat: ${profileData.alamat}`;
